...
<div class="topbar clearfix">
    <div class="inner">
        ...
        <ul class="atpsocials right">
            <li><a class="facebook" href="http://www.facebook.com/lucas.campanella"><img src="<?php echo $view['assets']->getUrl('images/guest/sociables/facebook.png') ?>" alt="" /></a></li>
            <li><a class="twitter" href="http://twitter.com/1uks"><img src="<?php echo $view['assets']->getUrl('images/guest/sociables/twitter.png') ?>" alt="" /></a></li>
            <li><a class="facebook" href="http://www.facebook.com/Buggyta"><img src="<?php echo $view['assets']->getUrl('images/guest/sociables/facebook.png') ?>" alt="" /></a></li>
            <li><a class="twitter" href="http://twitter.com/buggytta"><img src="<?php echo $view['assets']->getUrl('images/guest/sociables/twitter.png') ?>" alt="" /></a></li>
